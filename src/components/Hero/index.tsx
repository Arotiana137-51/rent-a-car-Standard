...
const Hero = () => {
  return (
    <>
      ...
      <section
        id="home"
        className="relative hidden 2xl:block overflow-hidden bg-lime-700 pt-[77px]"
      >
        <div className="w-full mx-auto px-4 sm:max-w-[400px] md:max-w-[540px] lg:max-w-[1520px]">
          <div className="-mx-4 flex flex-cols items-center">

            <div className="w-1/2 mx-12 "> {/* relative bg-cover bg-center"style={{ backgroundImage: "url('/images/hero/maxresdefault.webp')",backgroundSize: '100px 100px'  }}> */}
              {/* <Image
                src="/images/hero/maxresdefault.webp"
                alt="car drawing"
                width={500}
                height={100}
              /> */}
            ...
            <div className="w-1/2 mx-12">
              <div
                className="wow fadeInUp relative z-10 mx-0 max-w-[845px]"
                data-wow-delay=".25s"
              >
                <div className="mt-16 ">
                  <MadagascarSlider />
                </div>
                <div className="absolute -left-9 bottom-12 z-[-1]">
                  <svg
                    width="134"
                    height="106"
                    viewBox="0 0 134 106"
      ...
      <div className=" hidden lg:block 2xl:hidden relative h-5/6 w-full pb-14 overflow-hidden ">
        <div className="absolute inset-0 z-0">
          <MadagascarSlider />
        </div>
        <section
          id="home"
          className="relative overflow-hidden  pt-[330px]"
        >
      ...
      {/* //displays only on medium and small screens */}
      <section
        id="home"
        className="relative lg:hidden overflow-hidden bg-lime-700 pt-[120px] md:pt-[130px] lg:pt-[160px]"
      >
