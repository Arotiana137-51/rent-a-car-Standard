...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="w-full mx-auto px-4 sm:max-w-[400px] md:max-w-[540px] lg:max-w-[1520px]">{/* misy issue na responsiveness @ le izy nesorina le container */}
          ...
          <div className="flex items-center justify-start px-4">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-white px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark-2 lg:visible lg:static lg:w-full lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 lg:dark:bg-transparent ${navbarOpen
                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-xl text-dark group-hover:text-lime-600 dark:text-white dark:group-hover:text-lime-600 lg:inline-flex lg:px-0 lg:py-6 ${pathUrl === menuItem?.path && "text-lime-600"
                                }`}
                            >
                              {menuItem.title}
                            </Link>
                ...
                {/* {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-lime-800 bg-opacity-100 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-20 hover:text-dark"
                      >
                        Sign Out
                      </button>
                    ) : (
                  ...
                  <>
                    {pathUrl !== "/" ? (
                      <>
                        ...
                        <Link
                          href="/signup"
                          className="rounded-lg bg-lime-800 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-lime-800/90 dark:bg-white/10 dark:hover:bg-white/20"
                        >
                          Sign Up
                        </Link>
                      </>
                      ...
                      <>
                        ...
                        <Link
                          ...
                          className={`rounded-lg px-6 py-3 text-base font-medium text-white duration-300 ease-in-out ${
                            sticky
                              ? "bg-lime-800 hover:bg-lime-800/90 dark:bg-white/10 dark:hover:bg-white/20"
